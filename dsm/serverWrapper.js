...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _MainConfig = _interopRequireDefault(__webpack_require__(/*! ../../lib/MainConfig */ \"./src/lib/MainConfig.js\"));\n\nvar _prettyMs = _interopRequireDefault(__webpack_require__(/*! pretty-ms */ \"./node_modules/pretty-ms/index.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar pty = __webpack_require__(/*! node-pty */ \"node-pty\");\n\nlet RespondedToStatus = true;\nlet FailureTimer = false;\nlet IntervalTimer = false;\n\nconst RegisterToWrapperEmitter = GameServerEmitter => {\n  GameServerEmitter.on('startup', function (GameServer) {\n    GameServer.write('/echo DSM: Initilized Status Checker, checking every ' + (0, _prettyMs.default)(_MainConfig.default.STATUS_INTERVAL_MS) + '\\n');\n    IntervalTimer = setInterval(() => {\n      console.log('INTERVAL');\n      RespondedToStatus = false;\n      GameServer.write('/status\\n');\n      FailureTimer = setTimeout(() => {\n        console.log('/FAILED TO GET STATUS');\n        GameServerEmitter.emit('crash', GameServer); // Emit crash event, which will kill GameServer\n      }, 1000 * 30); // 30 seconds\n    }, _MainConfig.default.STATUS_INTERVAL_MS);\n  });\n  GameServerEmitter.on('status', function (data) {\n    RespondedToStatus = true;\n    if (FailureTimer !== false) clearTimeout(FailureTimer);\n    FailureTimer = false;\n  });\n  GameServerEmitter.on('exit', () => {\n    RespondedToStatus = true;\n    if (FailureTimer !== false) clearTimeout(FailureTimer);\n    FailureTimer = false;\n    if (IntervalTimer !== false) clearTimeout(IntervalTimer);\n    IntervalTimer = false;\n  });\n};\n\nvar _default = {\n  RegisterToWrapperEmitter\n};\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/bin/helpers/statusChecker.js?");
...
"use strict";
eval("\n\nvar _path = _interopRequireDefault(__webpack_require__(/*! path */ \"path\"));\n\nvar _localStorage = _interopRequireDefault(__webpack_require__(/*! ../lib/localStorage */ \"./src/lib/localStorage.js\"));\n\nvar globals = _interopRequireWildcard(__webpack_require__(/*! ../lib/globals */ \"./src/lib/globals.js\"));\n\nvar _ipcLayer = _interopRequireDefault(__webpack_require__(/*! ./helpers/ipcLayer */ \"./src/bin/helpers/ipcLayer.js\"));\n\nvar _statusChecker = _interopRequireDefault(__webpack_require__(/*! ./helpers/statusChecker */ \"./src/bin/helpers/statusChecker.js\"));\n\nvar _startGameServer = _interopRequireDefault(__webpack_require__(/*! ./helpers/startGameServer */ \"./src/bin/helpers/startGameServer.js\"));\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar events = __webpack_require__(/*! events */ \"events\").EventEmitter;\n\nvar GameServerEmitter = new events.EventEmitter();\n\n_ipcLayer.default.RegisterToWrapperEmitter(GameServerEmitter);\n\n_statusChecker.default.RegisterToWrapperEmitter(GameServerEmitter);\n\n// We then pipe the main process stdin (which is a readable stream)\n// into the child process stdin (which is a writable stream).\nconsole.log('-----Dirty Server Manager-----');\nconsole.log('DSM: Server Wrapper Initilized on pid: ' + process.pid);\n\n_localStorage.default.setItem('WrapperPid', process.pid);\n\nvar lockFile = __webpack_require__(/*! lockfile */ \"./node_modules/lockfile/lockfile.js\"); // opts is optional, and defaults to {}\n\n\nlockFile.lock(_path.default.resolve(globals.InstallationDir() + '/dsm/config.ini'), {}, function (er) {// if the er happens, then it failed to acquire a lock.\n}); // Start the game\n\n(0, _startGameServer.default)(GameServerEmitter);\nGameServerEmitter.on('crash', GameServer => {\n  console.log('Detected server crash, waiting 7 seconds');\n  GameServer.write('/save\\n'); // send save command just incase\n\n  setTimeout(() => {\n    GameServer.destroy(); // will trigger a GameServer Exit event\n\n    setTimeout(() => {\n      console.log('processing events...');\n      (0, _startGameServer.default)(GameServerEmitter);\n      console.log('Restarted');\n    }, 7000); // 7 seconds\n  }, 7000);\n});\nGameServerEmitter.on('shutdown', GameServer => {\n  GameServer.destroy(); // server shutdown, send exit event to wrapper\n});\nprocess.on('beforeExit', () => {\n  console.log('DSM: Closing wrapper GoodBye!');\n\n  _localStorage.default.clear();\n\n  process.exit(0);\n});\n\n//# sourceURL=webpack:///./src/bin/serverWrapper.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _fs = _interopRequireDefault(__webpack_require__(/*! fs */ \"fs\"));\n\nvar _ini = _interopRequireDefault(__webpack_require__(/*! ini */ \"./node_modules/ini/ini.js\"));\n\nvar _path = _interopRequireDefault(__webpack_require__(/*! path */ \"path\"));\n\nvar globals = _interopRequireWildcard(__webpack_require__(/*! ./globals */ \"./src/lib/globals.js\"));\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst config = _ini.default.parse(_fs.default.readFileSync(_path.default.resolve(globals.InstallationDir() + '/dsm/config.ini'), 'utf-8'));\n\nif (!config.STEAM_DIR) config.STEAM_DIR = \"steam\"; // default steam\n\nif (!config.STATUS_INTERVAL_MS) config.STATUS_INTERVAL_MS = 1000 * 60 * 5; // default 5 minutes\n\nconfig.STATUS_INTERVAL_MS = parseInt(config.STATUS_INTERVAL_MS, 10);\nvar _default = config;\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/lib/MainConfig.js?");
